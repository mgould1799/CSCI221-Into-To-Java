 ...
 *
 * This code should not be changed in solving HW problem 5
 */
public class Driver
{
    ...
    public static void main(String[] args) throws Exception{
        ...
        g.setColor(Color.GREEN); //can set the color of the 'brush' before drawing, then method doesn't need to worry about it
